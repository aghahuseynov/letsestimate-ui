            ...
            <div className={NavbarStyles.navbarLink}>
              <div>
                <button className="btn-blank">
                  <a
                    href="https://github.com/aghahuseynov/letsestimate-ui"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <svg
                  ...
                  <p className={NavbarStyles.navbarLinkTitle}>UI</p>
                </button>
                <button className="btn-blank">
                  <a
                    href="https://github.com/aghahuseynov/letsestimate-service"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <svg
                  ...
                  <p className={NavbarStyles.navbarLinkTitle}> Service</p>
                </button>
              </div>
              <div className={NavbarStyles.navbarEnd}>
                <div>
                  <Theme />
                  <About />
                </div>
